...
public class StatusClient extends BaseClient {
    ...
    public Response postTweet(RequestSpecification spec) {
        return post(spec, CREATE_TWEET_ENDPOINT);
    }

    public Response deleteTweet(RequestSpecification spec, long id) {
        return post(spec, DELETE_TWEET_ENDPOINT, ImmutableMap.of("id", id));
    }

    public Response postRetweet(RequestSpecification spec, long id) {
        return post(spec, RETWEET_ENDPOINT, ImmutableMap.of("id", id));
    }

    public Response deleteRetweet(RequestSpecification spec, long id) {
